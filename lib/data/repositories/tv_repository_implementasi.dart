...
class TvRepositoryImpl implements TvRepository {
  ...
  @override
  Future<Either<Failure, String>> saveWatchlistTv(TvSeriesDetail series) async {
    try {
      final result = await localDataSource
          .insertWatchlist(TvSeriesTable.fromEntity(series));
      return Right(result);
  ...
  Future<Either<Failure, String>> removeWatchlistTv(
    ...
    try {
      final result = await localDataSource
          .removeWatchlist(TvSeriesTable.fromEntity(series));
      return Right(result);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
    }
